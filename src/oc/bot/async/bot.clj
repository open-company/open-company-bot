...
(defn- notification-entry-url [msg post-data]
  (let [org (:org msg)
        ...
        uuid (:uuid post-data)
        board (:board msg)
        _ (timbre/debugf "notification-entry-url board: %s" board)
        _ (timbre/debugf " - board slug: %s" (:slug board))
        _ (timbre/debugf " - post board-slug: %s" (:board-slug post-data))
        _ (timbre/debugf " - board uuid: %s" (:uuid board))
        _ (timbre/debugf " - post board-uuid: %s" (:board-uuid post-data))
